...
DEFAULT_PROMPT_SUGGESTIONS = PersistentConfig(
    ...
    [
        {
            "title": ["General OPC UA", "What is OPC UA?"],
            "content": "How would you explain OPC UA to someone who has never heard of it before?",
        },
        {
            "title": ["OPC UA OMAC", "What states are defined in OMAC?"],
            "content": "Can you define the different states in the OMAC state machine?",
        },
        {
            "title": ["State Transitions", "about the transsition of all states in OMAC"],
            "content": "What are the possible transitions between states in the OMAC state machine?",
        },
        {
            "title": ["Integration with OPC UA", "OPCUA & OMAC"],
            "content": "How is the OMAC state machine integrated with OPC UA PackML?",
        }
    ]
)
